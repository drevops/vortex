...
export DREVOPS_TASK_PURGE_CACHE_ACQUIA_KEY="${DREVOPS_TASK_PURGE_CACHE_ACQUIA_KEY?not set}"
export DREVOPS_TASK_PURGE_CACHE_ACQUIA_SECRET="${DREVOPS_TASK_PURGE_CACHE_ACQUIA_SECRET?not set}"
export DREVOPS_TASK_PURGE_CACHE_ACQUIA_APP_NAME="${DREVOPS_ACQUIA_APP_NAME:-${site}}"
