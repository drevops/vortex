...
describe('Drupal.behaviors.ysDemo', () => {
  ...
  function createCounterBlockHtml() {
    return `
      <div data-ys-demo-counter>
        <span data-ys-demo-counter-value>0</span>
        <button data-ys-demo-counter-action="increment">+</button>
        <button data-ys-demo-counter-action="decrement">-</button>
        <button data-ys-demo-counter-action="reset">Reset</button>
      </div>
    `;
  }
  ...
  describe('storageKey', () => {
    it('should have the expected storage key', () => {
      expect(Drupal.behaviors.ysDemo.storageKey).toBe('ys_demo_counter_value');
    });
  });
  ...
  describe('initCounterBlock', () => {
    ...
    it('should initialize with saved localStorage value', () => {
      localStorage.setItem('ys_demo_counter_value', '15');
      document.body.innerHTML = createCounterBlockHtml();
      Drupal.behaviors.ysDemo.initCounterBlock(document);
    ...
    it('should save counter value to localStorage on click', () => {
      ...
      expect(localStorage.getItem('ys_demo_counter_value')).toBe('2');
    });
  ...
  describe('attach', () => {
    ...
    it('should fully initialize when called as a behavior', () => {
      ...
      const value = document.querySelector('[data-ys-demo-counter-value]');
      expect(value.textContent).toBe('1');
      expect(localStorage.getItem('ys_demo_counter_value')).toBe('1');
    });
  });
});
