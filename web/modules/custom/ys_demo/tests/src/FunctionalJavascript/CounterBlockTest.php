...
class CounterBlockTest extends WebDriverTestBase {
  ...
  public function testCounterBlockRenders(): void {
    ...
    $value = $this->assertSession()->elementExists('css', '[data-ys-demo-counter-value]');
  ...
  public function testIncrement(): void {
    ...
    $this->click('[data-ys-demo-counter-action="increment"]');
  ...
  public function testDecrement(): void {
    ...
    $this->click('[data-ys-demo-counter-action="decrement"]');
    $this->assertCounterValue('-1');
  }
  ...
  public function testReset(): void {
    ...
    $this->click('[data-ys-demo-counter-action="reset"]');
  ...
  protected function assertCounterValue(string $expected): void {
    $result = $this->assertSession()->waitForElementVisible('css', '[data-ys-demo-counter-value]');
