...
<div className="hero-container">
  ...
  <div className="hero-content">
    ...
    <div className="hero-description">
      <p>
        <strong>Vortex</strong> is a Drupal project template designed to
...
<div className="full-width-section">
  <div className="content-container">
    ...
    <p style={{ textAlign: 'center', fontSize: '1.25rem', color: '#4a5568', marginBottom: '3rem', maxWidth: '800px', margin: '0 auto 3rem' }}>
      A complete foundation for building and deploying Drupal sites with containerized environments,
      automated testing, code quality tools, CI/CD pipelines, and hosting platform integrations
    </p>
    <CardGrid>
      <Card
        icon="💧"
      ...
      <Card
        ...
        link="/features#quality-tools"
      />
      <Card
        icon="⚙️"
        title="Workflow"
        description="Useful workflows and automation including standardized deployment workflows, notifications, and automated dependency updates with Renovate"
