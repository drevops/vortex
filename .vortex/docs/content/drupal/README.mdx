...
Every shipped module is listed in [Composer configuration > `require`](composer-json.mdx#require),
together with what it does and whether it comes with
[pre-configured settings](settings.mdx#per-module-overrides).
