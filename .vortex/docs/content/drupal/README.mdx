...
| [`navigation_extra_tools`](https://www.drupal.org/project/navigation_extra_tools) | Adds administration shortcuts (clear caches, run cron, run updates) to the core Navigation module. |
...
| [`seckit`](https://www.drupal.org/project/seckit)                               | Provides security hardening options for HTTP headers and other protections.       |
