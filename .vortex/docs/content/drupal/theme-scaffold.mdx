...
(SDC) in `components/button` and renders it out of the box from
`your_site_theme.theme` as a usage example.

Components are validated with [SDC Devel](../tools/sdc-devel.mdx):
