...
**Vortex** generates content from `scripts/provision-10-enable-dev-modules.sh` on
a fresh database in non-production environments - one just imported from a dump
or installed from a profile.
