...
**Vortex** installs the module with `GENERATED_CONTENT_CREATE=1` from
`scripts/provision-10-enable-dev-modules.sh` in non-production environments, so
the content is created as part of the install.
