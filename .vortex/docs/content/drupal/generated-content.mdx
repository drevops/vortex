...
**Vortex** ships a `scripts/provision-15-generated-content.sh` custom script that
generates content on a freshly imported database in non-production environments.
