...
The legacy `scripts/custom` directory is still scanned for backward
compatibility but is deprecated. Move any such scripts into the `scripts`
directory; support for the legacy location will be removed in **Vortex** 1.40.
