...
- [`drevops/vortex-tooling`](https://github.com/drevops/vortex-tooling): Ships
  ...
  notification tooling - exposed as Composer binaries under
  `vendor/bin/vortex-*` (backed by `vendor/drevops/vortex-tooling/src/`).
...
- [`drupal/navigation_extra_tools`](https://www.drupal.org/project/navigation_extra_tools):
  Adds administration shortcuts - clear caches, run cron, run database updates -
  to the core Navigation module.
