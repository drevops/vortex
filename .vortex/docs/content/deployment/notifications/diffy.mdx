...
Dispatch a visual regression run against the newly deployed environment via the
shipped GitHub Actions workflow.

This channel doesn't call Diffy directly. It sends a GitHub
...
skipped because the target environment isn't yet ready for comparison.
