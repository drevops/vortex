...
| `VORTEX_NOTIFY_GITHUB_ENVIRONMENT_TYPE` | No | `${VORTEX_NOTIFY_LABEL}` | `.env` | Environment name (defaults to label, for example, `PR-123`) |
...
![GitHub pull request page showing a successful deployment with a View deployment button](/img/notification-github-after.png)
