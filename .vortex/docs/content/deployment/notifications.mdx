...
`VORTEX_NOTIFY_LOG_FILE`. By default only the trailing 100 lines are included,
to keep the email a reasonable size; adjust this with `VORTEX_NOTIFY_LOG_LINES`
(set to `0` to include the entire log).
