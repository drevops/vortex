...
This is the host-level check that runs before a project exists. Once a project is built, [`ahoy doctor`](./development/environment/doctor) goes further and inspects the running stack itself - ports, containers, the web server and the site bootstrap.
