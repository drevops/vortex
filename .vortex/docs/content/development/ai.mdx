...
The shipped `.gitignore` ignores everything under `.claude/` except
`settings.json`, so new skills stay local by default. To share skills with
your team, un-ignore the directory in your `.gitignore`:
