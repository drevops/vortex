...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ...
    3. `docker compose exec cli ./vendor/drevops/vortex-tooling/src/provision`
...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ```shell
    docker compose exec cli ./vendor/drevops/vortex-tooling/src/import-db
    docker compose exec cli ./vendor/drevops/vortex-tooling/src/import-db .data/db_custom.sql
    ```
  </TabItem>
</Tabs>
