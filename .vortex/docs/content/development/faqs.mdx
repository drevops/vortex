...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ...
    3. `docker compose exec cli ./vendor/drevops/vortex-tooling/src/provision.sh`
    ...
    ```shell
    docker compose down
    ./vendor/drevops/vortex-tooling/src/reset.sh
    docker compose up -d --build --force-recreate
    docker compose exec cli ./vendor/drevops/vortex-tooling/src/provision.sh
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ```shell
    docker compose exec cli ./vendor/drevops/vortex-tooling/src/import-db.sh
    docker compose exec cli ./vendor/drevops/vortex-tooling/src/import-db.sh .data/db_custom.sql
    ```
  </TabItem>
</Tabs>
