...
| [`drupal/drupal_helpers`](https://www.drupal.org/project/drupal_helpers) | A collection of helper functions that simplify writing update hooks and deployment operations. | [Drupal helpers](modules.mdx#drupal-helpers) |
...
| [`drupal/generated_content`](https://www.drupal.org/project/generated_content) | Generates deterministic placeholder content from declarative definitions for development and testing. | [Generated content](modules.mdx#generated-content), [Settings](settings.mdx#per-module-overrides) |
...
| [`drupal/testmode`](https://www.drupal.org/project/testmode) | Adjusts site behavior during automated tests, for example by filtering out generated content from listings. | [Testmode](modules.mdx#testmode), [Settings](settings.mdx#per-module-overrides) |
...
| [`drush/drush`](https://github.com/drush-ops/drush) | A command-line shell and scripting interface for Drupal, providing a wide range of utilities to manage and interact with your Drupal sites. | [Drush](environment.mdx#drush) |
...
- [`platform`](https://getcomposer.org/doc/06-config.md#platform): Specifies the
  ...
  kept in sync with the `php` version in the [Docker containers](environment.mdx#docker).
