...
In **Vortex**, it's integrated as a regular code quality tool that can be run
...
directory (`/tmp/rector_cached_files`) to speed up later runs by reusing
...
Rector doesn't support ignoring of the **code blocks**.
