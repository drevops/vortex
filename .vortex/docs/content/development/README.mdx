...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ...
    # Fully reset repository to a state as if it was just cloned
    docker compose down
    ./vendor/drevops/vortex-tooling/src/reset.sh hard
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ```shell
    ./vendor/drevops/vortex-tooling/src/doctor.sh                       # Check for common issues
    docker compose down && docker compose up -d      # Restart containers
    docker compose exec cli ./vendor/drevops/vortex-tooling/src/info.sh # Verify URLs and ports
    ```
  </TabItem>
</Tabs>
