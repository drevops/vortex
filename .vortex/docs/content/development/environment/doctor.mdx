...
<details>
  <summary>Expand to see the video of <code>ahoy doctor</code></summary>
...
Prints a system information report to attach to a support request. The report
covers the operating system version, the Docker, Docker Compose, Pygmy, and Ahoy
binaries with their versions, and the Docker daemon details. Usernames, IDs,
hashes, and IP addresses are redacted, so the output is safe to share.

<details>
  <summary>Expand to see the video of <code>ahoy doctor info</code></summary>
