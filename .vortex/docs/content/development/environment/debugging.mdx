...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ```shell
    XDEBUG_ENABLE=true docker compose up -d cli appserver webserver   # Restart containers with Xdebug enabled.
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="docker-compose" label="Docker Compose">
    ```shell
    docker compose up -d cli appserver webserver    # Restart containers with Xdebug disabled.
    ```
  </TabItem>
</Tabs>
...
3. Set a breakpoint in your IDE. `index.php` in your web root is a good place to
   start.
4. Run `ahoy debug` or `XDEBUG_ENABLE=true docker compose up -d cli appserver webserver`
   to enable Xdebug.
