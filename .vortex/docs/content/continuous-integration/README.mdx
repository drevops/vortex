...
- [Gitleaks](../development/security.mdx#secret-scanning) scans the codebase for committed secrets
...
| [Composer security audit](../development/security.mdx)       | Check dependencies for vulnerabilities  | `VORTEX_CI_COMPOSER_AUDIT_IGNORE_FAILURE`     |
...
| [Gitleaks](../development/security.mdx)                      | Scan the codebase for committed secrets | `VORTEX_CI_GITLEAKS_IGNORE_FAILURE`           |
