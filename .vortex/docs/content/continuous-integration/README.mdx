...
|-------------------------------------------------------------|------------------------------------------|-----------------------------------------------|
| [Behat](/docs/development/behat)                                  | Run BDD acceptance tests                 | `VORTEX_CI_BEHAT_IGNORE_FAILURE`              |
...
| [PHPUnit](/docs/development/phpunit)                              | Run unit, kernel, and functional tests   | `VORTEX_CI_PHPUNIT_IGNORE_FAILURE`            |
