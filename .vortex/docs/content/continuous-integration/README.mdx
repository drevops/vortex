...
- Runs all code linters: PHPCS, PHPStan, Rector, PHPMD, Twig CS Fixer, Gherkin Lint, ESLint, Stylelint
...
| [PHPMD](/docs/tools/phpmd)                                  | Detect PHP code smells and complexity    | `VORTEX_CI_PHPMD_IGNORE_FAILURE`              |
