...
[Set up continuous integration](/docs/installation?ci-provider=github-actions#5-set-up-continuous-integration)
...
`behat.yml`. See [Test parallelism](./parallelism.mdx) for the full procedure,
