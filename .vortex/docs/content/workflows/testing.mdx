...
**Vortex** provides a Unit test scaffold for custom [modules](https://github.com/drevops/vortex/blob/develop/web/modules/custom/ys_core/tests/src),
...
**Vortex** provides a [Drupal settings tests](https://github.com/drevops/vortex/blob/develop/tests/phpunit/DrupalSettingsTest.php)
...
It provides full Behat support, including configuration in [behat.yml](https://github.com/drevops/vortex/blob/develop/behat.yml)
and a [browser container](https://github.com/drevops/vortex/blob/develop/docker-compose.yml) to run interactive tests.
...
**Vortex** provides BDD test examples for custom [modules](https://github.com/drevops/vortex/blob/develop/web/modules/custom/ys_core/tests/src)
and [themes](https://github.com/drevops/vortex/blob/develop/web/themes/custom/your_site_theme/tests/src).
