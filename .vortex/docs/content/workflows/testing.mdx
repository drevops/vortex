...
**Vortex** provides BDD [tests boilerplate](https://github.com/drevops/vortex/blob/develop/tests/behat/features) for [homepage](https://github.com/drevops/vortex/blob/develop/tests/behat/features/homepage.feature)
