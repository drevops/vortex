...
Deployment occurs when tests pass in the CI environment.<br/>@see https://vortex.drevops.com/workflows/deployment
...
Applied if database sanitization is enabled.<br/>@see https://vortex.drevops.com/drupal/provision#database-sanitization
...
Database sanitization is enabled by default in all non-production<br/>environments and is always skipped in the production environment.<br/>@see https://vortex.drevops.com/drupal/provision#database-sanitization
