...
**Vortex** uses environment variables to configure workflows without code
changes.
...
Defined or used in: `.env.local.example`, `.env.local.example`, `scripts/vortex/download-db.sh`
...
Defined or used in: `scripts/vortex/notify-github.sh`, `scripts/vortex/notify-jira.sh`, `scripts/vortex/notify-webhook.sh`
...
Defined or used in: `scripts/vortex/notify-github.sh`, `scripts/vortex/notify.sh`
...
Defined or used in: `scripts/vortex/notify-webhook.sh`, `scripts/vortex/notify.sh`
