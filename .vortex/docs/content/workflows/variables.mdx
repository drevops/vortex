...
Defined in: `.env`, `scripts/vortex/download-db-acquia.sh`, `scripts/vortex/download-db-container-registry.sh`, `scripts/vortex/download-db-curl.sh`, `scripts/vortex/download-db-ftp.sh`, `scripts/vortex/download-db-lagoon.sh`, `scripts/vortex/download-db.sh`, `scripts/vortex/provision.sh`
...
Defined in: `.env`, `scripts/vortex/download-db-curl.sh`
...
Defined in: `.env`, `scripts/vortex/download-db-acquia.sh`, `scripts/vortex/download-db-curl.sh`, `scripts/vortex/download-db-ftp.sh`, `scripts/vortex/download-db-lagoon.sh`, `scripts/vortex/provision.sh`
...
Combination of comma-separated values to support multiple deployment targets:<br />`artifact`,`container_registry`, `webhook`, `lagoon`.
