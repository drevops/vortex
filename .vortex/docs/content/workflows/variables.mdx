...
Examples:<br/>https://github.com/drevops/vortex.git         # Will auto-discover the latest stable tag.<br/>https://github.com/drevops/vortex.git@stable  # Will auto-discover the latest stable tag.<br/>https://github.com/drevops/vortex.git@`1234567` # Will use the commit hash.<br/>/local/path/to/vortex<br/>/local/path/to/vortex@stable<br/>/local/path/to/vortex@ref
