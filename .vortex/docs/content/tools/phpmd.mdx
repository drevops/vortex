...
**Vortex** comes with [pre-configured PHPMD ruleset](https://github.com/drevops/vortex/blob/1.x/phpmd.xml)
for Drupal projects.
...
All global configuration takes place in the [`phpmd.xml`](https://github.com/drevops/vortex/blob/1.x/phpmd.xml)
file.
...
the [`phpmd.xml`](https://github.com/drevops/vortex/blob/1.x/phpmd.xml) file:
