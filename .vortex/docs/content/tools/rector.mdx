...
**Vortex** comes with [pre-configured Rector configuration](https://github.com/drevops/vortex/blob/1.x/rector.php)
...
the [`rector.php`](https://github.com/drevops/vortex/blob/1.x/rector.php)
file.
...
the [`rector.php`](https://github.com/drevops/vortex/blob/1.x/rector.php) file:
