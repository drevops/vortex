...
**Vortex** comes with [pre-configured Twig-cs-fixer ruleset](https://github.com/drevops/vortex/blob/1.x/.twig-cs-fixer.php) for Drupal projects.
...
All global configuration takes place in the [`.twig-cs-fixer.php`](https://github.com/drevops/vortex/blob/1.x/.twig-cs-fixer.php) file.
...
Ignoring rules **globally** takes place in the  [`.twig-cs-fixer.php`](https://github.com/drevops/vortex/blob/1.x/.twig-cs-fixer.php) file:
