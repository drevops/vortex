...
**Vortex** comes with [pre-configured PHPStan ruleset](https://github.com/drevops/vortex/blob/1.x/phpstan.neon)
for
Drupal projects.
...
the [`phpstan.neon`](https://github.com/drevops/vortex/blob/1.x/phpstan.neon)
file.
...
the [`phpstan.neon`](https://github.com/drevops/vortex/blob/1.x/phpstan.neon) file:
