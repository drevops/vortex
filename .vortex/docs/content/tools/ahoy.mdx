...
**Vortex** comes with [pre-configured `.ahoy.yml`](https://github.com/drevops/vortex/blob/1.x/.ahoy.yml) that has
...
It also provides an example of [local Ahoy `.ahoy.local.yml`](https://github.com/drevops/vortex/blob/1.x/.ahoy.local.example.yml)
