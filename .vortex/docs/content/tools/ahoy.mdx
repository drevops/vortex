...
**Vortex** comes with [pre-configured Ahoy file](https://github.com/drevops/vortex/blob/develop/.ahoy.yml) that has
...
It also provides an example of [local Ahoy file](https://github.com/drevops/vortex/blob/develop/.ahoy.local.example.yml)
