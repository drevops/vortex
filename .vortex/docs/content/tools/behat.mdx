...
**Vortex** comes with [pre-configured Behat profiles](https://github.com/drevops/vortex/blob/1.x/behat.yml) for Drupal projects.
...
All global configuration takes place in the [`behat.yml`](https://github.com/drevops/vortex/blob/1.x/behat.yml) file.
...
The [`FeatureContext.php`](https://github.com/drevops/vortex/blob/1.x/tests/behat/bootstrap/FeatureContext.php)
...
There are also example tests in the [`tests/behat/features`](https://github.com/drevops/vortex/blob/1.x/tests/behat/features)
