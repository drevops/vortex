...
**Vortex** comes with [Gherkin Lint configuration](https://github.com/drevops/vortex/blob/1.x/gherkinlint.json) for Behat tests.
...
All global configuration takes place in the [`gherkinlint.json`](https://github.com/drevops/vortex/blob/1.x/gherkinlint.json) file.
...
Ignoring rules **globally** takes place in the  [`gherkinlint.json`](https://github.com/drevops/vortex/blob/1.x/gherkinlint.json) file.
