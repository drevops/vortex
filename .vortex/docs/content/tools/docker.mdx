...
- `solr` - an optional container that runs Apache Solr 9 search server. This container
  ...
  accessed from the host via a randomly assigned port - run `docker compose port solr 8983`
