...
Specific commands are described in the relevant [Development](../development/README.mdx)
documentation.
...
- `database2` - an optional second database container holding the source
  database for [migrations](../drupal/migrations.mdx). It is only present when
