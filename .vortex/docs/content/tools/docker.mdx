...
Specific commands are described in the relevant [Development](/docs/development)
documentation.
...
- `cache` - an optional container that runs a Redis server. This container is
...
- Composer-generated Drupal directories, which are regenerated during the build
  (`web/core`, `web/modules/contrib`, `drush/Commands/contrib`).
