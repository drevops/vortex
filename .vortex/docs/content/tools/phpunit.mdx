...
**Vortex** comes with [pre-configured PHPCS ruleset](https://github.com/drevops/vortex/blob/1.x/phpunit.xml) for Drupal projects.
...
All global configuration takes place in the [`phpunit.xml`](https://github.com/drevops/vortex/blob/1.x/phpunit.xml) file.
