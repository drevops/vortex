...
**Vortex** comes with a [pre-configured PHPUnit configuration](https://github.com/drevops/vortex/blob/main/phpunit.xml) for Drupal projects.
...
### Running tagged tests with a `@group group_name` annotation
