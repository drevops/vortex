...
**Vortex** comes with [pre-configured PHPCS ruleset](https://github.com/drevops/vortex/blob/1.x/phpcs.xml) for Drupal projects.
...
All global configuration takes place in the [`phpcs.xml`](https://github.com/drevops/vortex/blob/1.x/phpcs.xml) file.
...
Ignoring rules **globally** takes place in the [`phpcs.xml`](https://github.com/drevops/vortex/blob/1.x/phpcs.xml) file:
