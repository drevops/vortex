...
- `.dockerignore` controls the container image build context.
  ➡️ See [Tools > Docker](./development/environment/docker#build-context-and-dockerignore)
...
➡️ See [Drupal > Provision](./development/provision)
...
➡️ See [Drupal > Module Scaffold](./development/modules/module-scaffold)
and [Drupal > Theme Scaffold](./development/themes)
...
➡️ See [Drupal > Settings](./development/settings)
...
➡️ See [Tools > Renovate](./development/dependency-updates)
