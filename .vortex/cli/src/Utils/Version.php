 ...
 * release). These helpers derive the major from the CLI's own stamped version
 * and from an installed project, so the CLI can both target the right major
 * and refuse cross-major operations.
 */
class Version {
