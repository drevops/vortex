...
/**
 * Vortex file operations with token fences and async content replacement.
 *
...
class File extends UpstreamFile {
   ...
   *
   * @return bool
   *   TRUE when the path is internal.
   */
   ...
   *
   * @param string|array<string,string>|callable $replacements
