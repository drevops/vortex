...
namespace DrevOps\VortexCli\Tests\Unit\Downloader;

use AlexSkrypnyk\File\File;
use DrevOps\VortexCli\Downloader\Artifact;
use DrevOps\VortexCli\Downloader\ArchiverInterface;
...
class RepositoryDownloaderTest extends UnitTestCase {
  ...
  public function testDownloadWithMockedArchiver(): void {
    ...
    /** @var \PHPUnit\Framework\MockObject\MockObject&\DrevOps\VortexCli\Downloader\ArchiverInterface $mock_archiver */
  ...
  /**
   * @return \PHPUnit\Framework\MockObject\MockObject&\DrevOps\VortexCli\Downloader\Downloader
