...
final class Config {
  ...
  const string DESTINATION = 'VORTEX_INSTALLER_DST_DIR';
  ...
  const string IS_DEMO_DB_FETCH_SKIP = 'VORTEX_INSTALLER_IS_DEMO_DB_FETCH_SKIP';
  ...
  const string PROMPTS = 'VORTEX_INSTALLER_PROMPTS';
