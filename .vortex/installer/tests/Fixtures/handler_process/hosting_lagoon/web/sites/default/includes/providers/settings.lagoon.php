...
if (!empty(getenv('LAGOON_KUBERNETES'))) {
  ...
  // Lagoon URL.
  // The amazee.io region for the autogenerated internal routes. Defaults to the
  // Australian region. Set the VORTEX_LAGOON_AMAZEEIO_REGION variable to another
  // region code (for example, "us") or leave it empty to skip this pattern.
