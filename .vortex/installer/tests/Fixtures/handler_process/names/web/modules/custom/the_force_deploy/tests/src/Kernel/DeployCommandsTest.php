...
namespace Drupal\Tests\the_force_deploy\Kernel;

use Consolidation\AnnotatedCommand\CommandData;
use Drupal\KernelTests\KernelTestBase;
use Drupal\the_force_deploy\Drush\Commands\DeployCommands;
use PHPUnit\Framework\Attributes\Group;

/**
 * Tests DeployCommands against a real site.
 *
 * @package Drupal\the_force_deploy\Tests
 */
#[Group('TheForceDeploy')]
class DeployCommandsTest extends KernelTestBase {

  /**
   * {@inheritdoc}
   */
  protected static $modules = ['the_force_deploy'];
