...
namespace Drupal\Tests\the_force_demo\FunctionalJavascript;
...
class CounterBlockTest extends WebDriverTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->drupalPlaceBlock('the_force_demo_counter_block', [
      'region' => 'content',
  ...
  public function testCounterBlockRenders(): void {
    ...
    $block = $this->assertSession()->waitForElement('css', '[data-the-force-demo-counter]');
    $this->assertNotNull($block, 'Counter block is present on the page.');

    $value = $this->assertSession()->elementExists('css', '[data-the-force-demo-counter-value]');
  ...
  public function testDecrement(): void {
    ...
    $this->click('[data-the-force-demo-counter-action="decrement"]');
    $this->assertCounterValue('-1');
  }
  ...
  protected function assertCounterValue(string $expected): void {
    $result = $this->assertSession()->waitForElementVisible('css', '[data-the-force-demo-counter-value]');
