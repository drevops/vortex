...
# front-end assets.
COPY ${WEBROOT}/themes/custom/sut/Gruntfile.js ${WEBROOT}/themes/custom/sut/.eslintrc.json ${WEBROOT}/themes/custom/sut/package.json ${WEBROOT}/themes/custom/sut/package* /app/${WEBROOT}/themes/custom/sut/
COPY ${WEBROOT}/themes/custom/sut/patches /app/${WEBROOT}/themes/custom/sut/patches
...
RUN npm --prefix /app/${WEBROOT}/themes/custom/sut ci --no-audit --no-progress --unsafe-perm
...
WORKDIR /app/${WEBROOT}/themes/custom/sut
RUN npm run build
