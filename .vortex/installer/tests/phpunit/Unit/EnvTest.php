...
class EnvTest extends UnitTestBase {
  ...
  public static function dataProviderGetFromDotenv() {
    return [
      ['VAR', 'VAL1', NULL, 'VAL1'],
  ...
  public static function dataProviderPutFromDotenv() {
    return [
