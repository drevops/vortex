...
class PromptManagerTest extends UnitTestBase {
   ...
   * @covers ::initHandlers
   * @covers ::getResponses
   * @covers \DrevOps\Installer\Prompts\Handlers\Profile::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Webroot::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Theme::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Name::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\MachineName::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Org::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\OrgMachineName::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Domain::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\CodeProvider::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\GithubRepo::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\ModulePrefix::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\ThemeRunner::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Services::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\HostingProvider::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\DeployType::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\ProvisionType::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\DatabaseDownloadSource::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\DatabaseImage::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\CiProvider::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\DependencyUpdatesProvider::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\AssignAuthorPr::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\LabelMergeConflictsPr::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\PreserveDocsProject::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\PreserveDocsOnboarding::discover
   * @covers \DrevOps\Installer\Prompts\Handlers\Internal::discover
