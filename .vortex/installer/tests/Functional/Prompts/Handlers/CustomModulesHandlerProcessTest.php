...
class CustomModulesHandlerProcessTest extends AbstractHandlerProcessTestCase {
  ...
  public static function dataProviderHandlerProcess(): \Iterator {
    yield 'custom_modules_no_base' => [
      ...
      static::cw(fn(AbstractHandlerProcessTestCase $test) => $test->assertSutNotContains('_base')),
    ];
    ...
    yield 'custom_modules_none' => [
      static::cw(fn(AbstractHandlerProcessTestCase $test): array => $test->prompts[CustomModules::id()] = []),
      static::cw(function (AbstractHandlerProcessTestCase $test): void {
