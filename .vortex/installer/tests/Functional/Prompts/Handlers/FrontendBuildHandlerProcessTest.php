...
class FrontendBuildHandlerProcessTest extends AbstractHandlerProcessTestCase {
  ...
  public static function dataProviderHandlerProcess(): \Iterator {
    yield 'frontend_build_container' => [
      static::cw(fn(AbstractHandlerProcessTestCase $test): true => $test->prompts[FrontendBuild::id()] = TRUE),
    ...
    yield 'frontend_build_skip' => [
      static::cw(fn(AbstractHandlerProcessTestCase $test): false => $test->prompts[FrontendBuild::id()] = FALSE),
      static::cw(function (AbstractHandlerProcessTestCase $test): void {
