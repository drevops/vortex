...
class CodeProviderHandlerProcessTest extends AbstractHandlerProcessTestCase {
  ...
  public static function dataProviderHandlerProcess(): \Iterator {
    yield 'code_provider_github' => [
      static::cw(fn(AbstractHandlerProcessTestCase $test): string => $test->prompts[CodeProvider::id()] = CodeProvider::GITHUB),
    ...
    yield 'code_provider_other' => [
      static::cw(fn(AbstractHandlerProcessTestCase $test): string => $test->prompts[CodeProvider::id()] = CodeProvider::OTHER),
      static::cw(function (AbstractHandlerProcessTestCase $test): void {
