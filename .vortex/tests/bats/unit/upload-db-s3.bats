...
@test "upload-db-s3: Upload database file successfully" {
  ...
  export VORTEX_DB_UPLOAD_S3_ACCESS_KEY="testaccesskey"
  export VORTEX_DB_UPLOAD_S3_SECRET_KEY="testsecretkey"
  export VORTEX_DB_UPLOAD_S3_BUCKET="test-bucket"
  export VORTEX_DB_UPLOAD_S3_REGION="ap-southeast-2"
...
@test "upload-db-s3: Use shortcut variables" {
  ...
  export VORTEX_DB_UPLOAD_S3_ACCESS_KEY=""
  export VORTEX_DB_UPLOAD_S3_SECRET_KEY=""
  export VORTEX_DB_UPLOAD_S3_BUCKET=""
  export VORTEX_DB_UPLOAD_S3_REGION=""
  # Set shortcut variables instead of VORTEX_DB_UPLOAD_S3_* variables.
...
@test "upload-db-s3: Use custom remote file name" {
  ...
  export VORTEX_DB_DIR=".data"
  export VORTEX_DB_FILE="db.sql"
  export VORTEX_DB_UPLOAD_S3_REMOTE_FILE="backup/db_latest.sql"
...
@test "upload-db-s3: Use custom prefix" {
  ...
  export VORTEX_DB_UPLOAD_S3_BUCKET="test-bucket"
  export VORTEX_DB_UPLOAD_S3_REGION="ap-southeast-2"
  export VORTEX_DB_UPLOAD_S3_PREFIX="backups/daily/"
  export VORTEX_DB_DIR=".data"
  export VORTEX_DB_FILE="db.sql"
...
@test "upload-db-s3: Fail when VORTEX_DB_UPLOAD_S3_ACCESS_KEY is missing" {
  pushd "${LOCAL_REPO_DIR}" >/dev/null || exit 1

  declare -a STEPS=(
    "[FAIL] Missing required value for VORTEX_DB_UPLOAD_S3_ACCESS_KEY."
    "- [ OK ] Finished database dump upload to S3."
  )
...
@test "upload-db-s3: Fail when VORTEX_DB_UPLOAD_S3_SECRET_KEY is missing" {
  pushd "${LOCAL_REPO_DIR}" >/dev/null || exit 1

  declare -a STEPS=(
    "[FAIL] Missing required value for VORTEX_DB_UPLOAD_S3_SECRET_KEY."
    "- [ OK ] Finished database dump upload to S3."
  )
...
@test "upload-db-s3: Fail when VORTEX_DB_UPLOAD_S3_BUCKET is missing" {
  pushd "${LOCAL_REPO_DIR}" >/dev/null || exit 1

  declare -a STEPS=(
    "[FAIL] Missing required value for VORTEX_DB_UPLOAD_S3_BUCKET."
    "- [ OK ] Finished database dump upload to S3."
  )
...
@test "upload-db-s3: Fail when VORTEX_DB_UPLOAD_S3_REGION is missing" {
  pushd "${LOCAL_REPO_DIR}" >/dev/null || exit 1

  declare -a STEPS=(
    "[FAIL] Missing required value for VORTEX_DB_UPLOAD_S3_REGION."
    "- [ OK ] Finished database dump upload to S3."
  )
