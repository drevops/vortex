...
class DockerComposeWorkflowTest extends FunctionalTestCase {
  ...
  public function testDockerComposeWorkflowFull(): void {
    ...
    $this->cmd('docker compose exec -T cli ./vendor/drevops/vortex-tooling/src/provision.sh', txt: 'Run ./vendor/drevops/vortex-tooling/src/provision.sh in container', tio: 10 * 60);
