...
class AhoyWorkflowTest extends FunctionalTestCase {
  ...
  public function testAhoyWorkflowStateless(): void {
    static::$sutEnv = ['VORTEX_INSTALLER_IS_DEMO' => '1'];
    $this->prepareSut();
  ...
  public function testAhoyWorkflowDatabaseFromImageStorageInImage(): void {
    ...
    $this->assertFileContainsString('.env', 'VORTEX_FETCH_DB_SOURCE=container_registry', '.env should contain container registry source');
    ...
    $this->assertFileNotContainsString('.env', 'VORTEX_DB_IMAGE=drevops/vortex-dev-mariadb-drupal-data-demo-11.x:1.40.0', '.env should not contain demo database image');
  ...
  public function testAhoyWorkflowMigration(): void {
    ...
    // Verify the CLI produced the migration infrastructure.
  ...
  public function testAhoyWorkflowMigrationDatabaseFromImage(): void {
    ...
    $this->assertFileContainsString('.env', 'VORTEX_FETCH_DB2_SOURCE=container_registry', '.env should contain container registry source for migration');
