...
class PushDbS3Test extends UnitTestCase {

  protected function setUp(): void {
    parent::setUp();

    $this->envSet('VORTEX_PUSH_DB_S3_ACCESS_KEY', 'AKIAIOSFODNN7EXAMPLE');
    $this->envSet('VORTEX_PUSH_DB_S3_SECRET_KEY', 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY');
    $this->envSet('VORTEX_PUSH_DB_S3_BUCKET', 'mybucket');
    $this->envSet('VORTEX_PUSH_DB_S3_REGION', 'us-east-1');
    $this->envSet('VORTEX_PUSH_DB_S3_DB_DIR', self::$tmp . '/data');
    $this->envSet('VORTEX_PUSH_DB_S3_DB_FILE', 'db.sql');
  }
  ...
  public function testSuccessWithPrefix(): void {
    ...
    $this->envSet('VORTEX_PUSH_DB_S3_PREFIX', 'backups/daily');
