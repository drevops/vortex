...
[![CircleCI](https://circleci.com/gh/integratedexperts/drevops/tree/8.x.svg?style=shield)](https://circleci.com/gh/integratedexperts/drevops/tree/8.x)
![Drupal 7](https://img.shields.io/badge/Drupal-7-blue.svg)
[![Licence: GPL 3](https://img.shields.io/badge/licence-GPL3-blue.svg)](https://github.com/integratedexperts/drevops/blob/7.x/LICENSE)
...
[Click here to switch to Drupal 8 version](https://github.com/integratedexperts/drevops/tree/8.x)

![Workflow](https://raw.githubusercontent.com/wiki/integratedexperts/drevops/images/workflow.png)
...
1. Install DrevOps<br/>
   ...
   ```
   bash <(curl -L https://raw.githubusercontent.com/integratedexperts/drevops/8.x/install.sh)
   ```
   For interactive installation (questions and answers) into current directory:
   ```
   bash <(curl -L https://raw.githubusercontent.com/integratedexperts/drevops/8.x/install.sh) --interactive
   ```
<details>
<summary>Show Installer screenshot</summary>

![Installer](https://raw.githubusercontent.com/wiki/integratedexperts/drevops/images/installer.png)
</details>
...
![Installer](https://raw.githubusercontent.com/wiki/integratedexperts/drevops/images/project-update.png)
</details>
...
## Contributing
- Progress is tracked as [GitHub project](https://github.com/integratedexperts/drevops/projects/1). 
...
[![DrevOps](https://img.shields.io/badge/DrevOps-DREVOPS_VERSION_URLENCODED-blue.svg)](https://github.com/integratedexperts/drevops/tree/DREVOPS_VERSION) 
