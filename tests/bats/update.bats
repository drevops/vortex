...
@test "Update" {
  ...
  echo "# Some change to non-required file" >> "${LOCAL_REPO_DIR}/docroot/sites/all/themes/custom/star_wars/.eslintrc.json"
  git_add "${LOCAL_REPO_DIR}" "docroot/sites/all/themes/custom/star_wars/.eslintrc.json"
