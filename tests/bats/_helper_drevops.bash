...
setup(){
  ...
  DEMO_DB_TEST=https://raw.githubusercontent.com/wiki/integratedexperts/drevops/db_d7.star_wars.sql.md
  export DEMO_DB_TEST
...
assert_files_present_common(){
  ...
  assert_file_contains "README.md" "https://github.com/integratedexperts/drevops/tree/${DRUPAL_VERSION}.x"
