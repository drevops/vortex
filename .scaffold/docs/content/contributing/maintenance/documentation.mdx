...
There are 2 types of the documentation that **Scaffold** provides:

1. This Documentation of **Scaffold** that is then deployed
   to https://docs.drevops.com/
2. Consumer site documentation that is distributed when **Scaffold** is
   installed.
...
removed when you install **Scaffold** for a
consumer site.
...
**Scaffold** provides a scaffold of the consumer site documentation in the
[`docs`](https://github.com/drevops/scaffold/blob/develop/docs) directory.

After **Scaffold** is installed into the consumer site, these docs are
