...
**Scaffold** team will keep the `composer.json` file up-to-date with the
...
licence of the project. Since **Scaffold** is a template for your consumer sites
...
- `drupal/admin_toolbar`, `drupal/clamav`, `drupal/coffee`, etc. - Drupal
  ...
  **Scaffold** comes with [pre-configured settings](settings.mdx) for some of the
