...
:::note
    ...
    See [Working with packages](../workflows/packages.mdx) for more information
...
See [Working with packages](../workflows/packages.mdx) for more information on
...
- [`cweagans/composer-patches`](https://github.com/cweagans/composer-patches):
  ...
  See [Working with packages](../workflows/packages.mdx#patching) for more
