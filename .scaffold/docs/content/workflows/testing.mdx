...
**Scaffold** uses PHPUnit as a framework for Unit testing.
...
**Scaffold** provides a Unit test scaffold for custom [modules](https://github.com/drevops/scaffold/blob/develop/web/modules/custom/ys_core/tests/src),
...
These tests already run in CI when you install **Scaffold** and can be used as a
starting point for writing your own.

#### Drupal settings tests

**Scaffold** provides a [Drupal settings tests](https://github.com/drevops/scaffold/blob/develop/tests/phpunit/DrupalSettingsTest.php)
...
**Scaffold** provides a [CI configuration tests](https://github.com/drevops/scaffold/blob/develop/tests/phpunit/CircleCiConfigTest.php)
...
**Scaffold** uses Behat for Behavior-Driven Development (BDD) testing.
...
In CI, the profile can be overridden using `$DREVOPS_CI_BEHAT_PROFILE` environment
variable.
...
Out of the box, **Scaffold** provides support for unlimited parallel
...
Out of the box, **Scaffold** comes with [Behat Progress formatter](https://github.com/drevops/behat-format-progress-fail)
...
**Scaffold** provides BDD test examples for custom [modules](https://github.com/drevops/scaffold/blob/develop/web/modules/custom/ys_core/tests/src)
and [themes](https://github.com/drevops/scaffold/blob/develop/web/themes/custom/your_site_theme/tests/src).

These tests already run in CI when you install **Scaffold** and can be used
