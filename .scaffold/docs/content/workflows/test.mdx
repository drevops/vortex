...
DrevOps Scaffold uses PHPUnit as a framework for Unit testing.
...
DrevOps Scaffold provides a Unit test scaffold for custom [modules](https://github.com/drevops/scaffold/blob/develop/web/modules/custom/ys_core/tests/src),
...
These tests already run in CI when you install DrevOps Scaffold and can be used as a
starting point for writing your own.

#### Drupal settings tests

DrevOps Scaffold provides a [Drupal settings tests](https://github.com/drevops/scaffold/blob/develop/tests/phpunit/DrupalSettingsTest.php)
...
DrevOps Scaffold provides a [CI configuration tests](https://github.com/drevops/scaffold/blob/develop/tests/phpunit/CircleCiConfigTest.php)
...
DrevOps Scaffold uses Behat for Behavior-Driven Development (BDD) testing.
...
Out of the box, DrevOps Scaffold provides support for unlimited parallel
...
Out of the box, DrevOps Scaffold comes with [Behat Progress formatter](https://github.com/drevops/behat-format-progress-fail)
...
DrevOps Scaffold provides a BDD test scaffold for custom [modules](https://github.com/drevops/scaffold/blob/develop/web/modules/custom/ys_core/tests/src)
and [themes](https://github.com/drevops/scaffold/blob/develop/web/themes/custom/your_site_theme/tests/src).

These tests already run in CI when you install DrevOps Scaffold and can be used
