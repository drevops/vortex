...
Defined in: `.env`, `scripts/drevops/login-container-registry.sh`

### `DREVOPS_CONTAINER_REGISTRY_PASS`

The password (token) to log into the container registry.

Default value: `${DOCKER_PASS}`

Defined in: `.env.local.default`, `scripts/drevops/login-container-registry.sh`

### `DREVOPS_CONTAINER_REGISTRY_USER`
...
Defined in: `.env`, `scripts/drevops/download-db-acquia.sh`, `scripts/drevops/download-db-container-registry.sh`, `scripts/drevops/download-db-curl.sh`, `scripts/drevops/download-db-ftp.sh`, `scripts/drevops/download-db-lagoon.sh`, `scripts/drevops/download-db.sh`, `scripts/drevops/provision.sh`
...
Note that "container_registry" works only for database-in-image<br />database storage (when [`$DREVOPS_DB_IMAGE`](#drevops_db_image) variable has a value).
...
Defined in: `.env`, `scripts/drevops/download-db-container-registry.sh`, `scripts/drevops/export-db.sh`, `scripts/drevops/info.sh`, `scripts/drevops/provision.sh`
...
Defined in: `.env`, `scripts/drevops/download-db-container-registry.sh`
...
### `DREVOPS_DEPLOY_CONTAINER_REGISTRY`
...
Defined in: `scripts/drevops/deploy-container-registry.sh`

### `DREVOPS_DEPLOY_CONTAINER_REGISTRY_IMAGE_TAG`
...
### `DREVOPS_DEPLOY_CONTAINER_REGISTRY_MAP`
...
Defined in: `scripts/drevops/deploy-container-registry.sh`, `scripts/drevops/export-db.sh`

### `DREVOPS_DEPLOY_CONTAINER_REGISTRY_PASS`

The password to login into the container registry.

Default value: `${DREVOPS_CONTAINER_REGISTRY_PASS}`
...
Default value: `${DREVOPS_CONTAINER_REGISTRY_USER}`
...
### `DREVOPS_DOWNLOAD_DB_CONTAINER_REGISTRY`
...
### `DREVOPS_DOWNLOAD_DB_CONTAINER_REGISTRY_PASS`
...
### `DREVOPS_DOWNLOAD_DB_CONTAINER_REGISTRY_USER`
...
### `DREVOPS_LAGOONCLI_FORCE_INSTALL`

Flag to force the installation of Lagoon CLI.

Default value: `UNDEFINED`

Defined in: `scripts/drevops/deploy-lagoon.sh`, `scripts/drevops/task-custom-lagoon.sh`

### `DREVOPS_LAGOONCLI_PATH`
