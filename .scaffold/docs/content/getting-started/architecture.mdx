...
Similar to [Zen of Python](https://www.python.org/dev/peps/pep-0020/), **Scaffold**
...
├── scripts                  # Composer, Scaffold and custom project scripts.
│   ├── composer             #   Composer scripts.
│   ├── custom               #   Custom project scripts.
│   └── drevops              #   Scaffold workflow scripts.
...
**Scaffold** comes with as set of pre-defined workflow scripts used to
