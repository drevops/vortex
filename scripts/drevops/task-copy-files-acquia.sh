...
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_KEY}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_KEY." && exit 1
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_SECRET}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_SECRET." && exit 1
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_APP_NAME}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_APP_NAME." && exit 1
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_SRC}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_SRC." && exit 1
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_DST}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_DST." && exit 1
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_STATUS_RETRIES}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_STATUS_RETRIES." && exit 1
[ -z "${DREVOPS_TASK_COPY_FILES_ACQUIA_STATUS_INTERVAL}" ] && fail "Missing value for DREVOPS_TASK_COPY_FILES_ACQUIA_STATUS_INTERVAL." && exit 1
...
note "Retrieving ${DREVOPS_TASK_COPY_FILES_ACQUIA_APP_NAME} application UUID."
...
note "Copying files from ${DREVOPS_TASK_COPY_FILES_ACQUIA_SRC} to ${DREVOPS_TASK_COPY_FILES_ACQUIA_DST} environment."
...
for i in $(seq 1 "${DREVOPS_TASK_COPY_FILES_ACQUIA_STATUS_RETRIES}"); do
  echo -n "."
...
if [ "${task_completed}" = "0" ]; then
  fail "Unable to copy files from $DREVOPS_TASK_COPY_FILES_ACQUIA_SRC to $DREVOPS_TASK_COPY_FILES_ACQUIA_DST environment."
  exit 1
fi
