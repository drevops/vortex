...
@test "Install into empty directory; db from curl; storage is Docker image" {
  ...
  export DREVOPS_DB_DOCKER_IMAGE="drevops/drevops-mariadb-drupal-data-demo-10.x:buildx-int-test1"

  run_install_quiet

  assert_file_contains ".env" "DREVOPS_DB_DOWNLOAD_SOURCE=curl"
  assert_file_contains ".env" "DREVOPS_DB_DOWNLOAD_CURL_URL="
  assert_file_contains ".env" "DREVOPS_DB_DOCKER_IMAGE=drevops/drevops-mariadb-drupal-data-demo-10.x:buildx-int-test1"
}
