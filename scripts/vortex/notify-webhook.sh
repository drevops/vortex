...
VORTEX_NOTIFY_WEBHOOK_PAYLOAD=$(php -r "echo str_replace('%label%', '${VORTEX_NOTIFY_WEBHOOK_LABEL}', '${VORTEX_NOTIFY_WEBHOOK_PAYLOAD}');")
...
VORTEX_NOTIFY_WEBHOOK_PAYLOAD=$(php -r "echo str_replace('%login_url%', '${VORTEX_NOTIFY_WEBHOOK_LOGIN_URL}', '${VORTEX_NOTIFY_WEBHOOK_PAYLOAD}');")
