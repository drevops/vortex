...
content=$(php -r "echo str_replace('%project%', '${VORTEX_NOTIFY_EMAIL_PROJECT}', '${content}');")
content=$(php -r "echo str_replace('%label%', '${VORTEX_NOTIFY_EMAIL_LABEL}', '${content}');")
content=$(php -r "echo str_replace('%timestamp%', '${timestamp}', '${content}');")
content=$(php -r "echo str_replace('%environment_url%', '${VORTEX_NOTIFY_EMAIL_ENVIRONMENT_URL}', '${content}');")
content=$(php -r "echo str_replace('%login_url%', '${VORTEX_NOTIFY_EMAIL_LOGIN_URL}', '${content}');")
