...
VORTEX_TASK_COPY_DB_ACQUIA_KEY="${VORTEX_TASK_COPY_DB_ACQUIA_KEY:-${VORTEX_ACQUIA_KEY:-}}"

# Acquia Cloud API secret.
VORTEX_TASK_COPY_DB_ACQUIA_SECRET="${VORTEX_TASK_COPY_DB_ACQUIA_SECRET:-${VORTEX_ACQUIA_SECRET:-}}"

# Application name. Used to discover UUID.
VORTEX_TASK_COPY_DB_ACQUIA_APP_NAME="${VORTEX_TASK_COPY_DB_ACQUIA_APP_NAME:-${VORTEX_ACQUIA_APP_NAME:-}}"

# Source environment name to copy DB from.
VORTEX_TASK_COPY_DB_ACQUIA_SRC="${VORTEX_TASK_COPY_DB_ACQUIA_SRC:-}"

# Destination environment name to copy DB to.
VORTEX_TASK_COPY_DB_ACQUIA_DST="${VORTEX_TASK_COPY_DB_ACQUIA_DST:-}"
...
VORTEX_TASK_COPY_DB_ACQUIA_STATUS_RETRIES="${VORTEX_TASK_COPY_DB_ACQUIA_STATUS_RETRIES:-600}"

# Interval in seconds to check task status.
VORTEX_TASK_COPY_DB_ACQUIA_STATUS_INTERVAL="${VORTEX_TASK_COPY_DB_ACQUIA_STATUS_INTERVAL:-10}"
...
[ -z "${VORTEX_TASK_COPY_DB_ACQUIA_KEY}" ] && fail "Missing value for VORTEX_TASK_COPY_DB_ACQUIA_KEY or VORTEX_ACQUIA_KEY." && exit 1
[ -z "${VORTEX_TASK_COPY_DB_ACQUIA_SECRET}" ] && fail "Missing value for VORTEX_TASK_COPY_DB_ACQUIA_SECRET or VORTEX_ACQUIA_SECRET." && exit 1
[ -z "${VORTEX_TASK_COPY_DB_ACQUIA_APP_NAME}" ] && fail "Missing value for VORTEX_TASK_COPY_DB_ACQUIA_APP_NAME or VORTEX_ACQUIA_APP_NAME." && exit 1
[ -z "${VORTEX_TASK_COPY_DB_ACQUIA_SRC}" ] && fail "Missing value for VORTEX_TASK_COPY_DB_ACQUIA_SRC." && exit 1
[ -z "${VORTEX_TASK_COPY_DB_ACQUIA_DST}" ] && fail "Missing value for VORTEX_TASK_COPY_DB_ACQUIA_DST." && exit 1
[ -z "${VORTEX_TASK_COPY_DB_ACQUIA_NAME}" ] && fail "Missing value for VORTEX_TASK_COPY_DB_ACQUIA_NAME." && exit 1
