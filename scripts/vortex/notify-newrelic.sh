...
VORTEX_NOTIFY_NEWRELIC_DESCRIPTION=$(php -r "echo str_replace('%project%', '${VORTEX_NOTIFY_NEWRELIC_PROJECT}', '${VORTEX_NOTIFY_NEWRELIC_DESCRIPTION}');")
VORTEX_NOTIFY_NEWRELIC_DESCRIPTION=$(php -r "echo str_replace('%label%', '${VORTEX_NOTIFY_NEWRELIC_LABEL}', '${VORTEX_NOTIFY_NEWRELIC_DESCRIPTION}');")
VORTEX_NOTIFY_NEWRELIC_DESCRIPTION=$(php -r "echo str_replace('%timestamp%', '${timestamp}', '${VORTEX_NOTIFY_NEWRELIC_DESCRIPTION}');")
VORTEX_NOTIFY_NEWRELIC_DESCRIPTION=$(php -r "echo str_replace('%environment_url%', '${VORTEX_NOTIFY_NEWRELIC_ENVIRONMENT_URL}', '${VORTEX_NOTIFY_NEWRELIC_DESCRIPTION}');")
VORTEX_NOTIFY_NEWRELIC_DESCRIPTION=$(php -r "echo str_replace('%login_url%', '${VORTEX_NOTIFY_NEWRELIC_LOGIN_URL}', '${VORTEX_NOTIFY_NEWRELIC_DESCRIPTION}');")
...
if [ -z "${VORTEX_NOTIFY_NEWRELIC_APPID}" ] && [ -n "${VORTEX_NOTIFY_NEWRELIC_APP_NAME}" ]; then
  VORTEX_NOTIFY_NEWRELIC_APPID="$(curl -s -X GET "${VORTEX_NOTIFY_NEWRELIC_ENDPOINT}/applications.json" \
    -H "X-Api-Key:${VORTEX_NOTIFY_NEWRELIC_USER_KEY}" \
